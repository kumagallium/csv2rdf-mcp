...
| **3. WebVOWL レンダリング** | starrydata.ttl を upload | [TIB WebVOWL 直接 open](https://service.tib.eu/webvowl/#iri=https://kumagallium.github.io/csv2rdf-mcp/starrydata/ontology/ontology.ttl) (うまく開かない場合は [手動 upload](https://service.tib.eu/webvowl/)) | **インタラクティブな円形グラフ**で他人と共有 |
| **4. ライブ landing page** | GitHub Pages | [kumagallium.github.io/csv2rdf-mcp/starrydata/ontology/](https://kumagallium.github.io/csv2rdf-mcp/starrydata/ontology/) | **dereferenceable な IRI** が実体を返す (`sd:Paper` 等を踏むとこのページが返る) |
